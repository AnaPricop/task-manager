    ...
    return (
        <div className='ShowBookList p-3 row '>
            ...
            <div className="list row py-2">
                ...
                <div className=' list2 mx-5 my-4 col-lg-2 col-md-8 justify-content-center d-flex'>
                    <div className="col-4 px-2 py-2 icon-statistic" style={{backgroundColor: '#DB534F'}}>
                        <svg viewBox="0 0 24 24" width="35px" height="35px" xmlns="http://www.w3.org/2000/svg"
                ...
                <div className=' list2 mx-5 my-4 col-lg-2 col-md-8 justify-content-center d-flex'>
                    <div className="col-4 px-2 py-2 icon-statistic" style={{backgroundColor: '#DBC04F'}}>
                ...
                {/*    <div className="col-4 px-2 py-2 icon-statistic" style={{backgroundColor: '#0084ff'}}>*/}
                {/*        <svg viewBox="0 0 24 24" width="35px" height="35px" xmlns="http://www.w3.org/2000/svg"*/}
                {/*             mirror-in-rtl="true" fill="white">*/}
                {/*            <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>*/}
                {/*            <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>*/}
                ...
                {/*</div>*/}
                <div className=' list2 mx-5 my-4 col-lg-2 col-md-8 justify-content-center d-flex'>
                    <div className="col-4 px-2 py-2 icon-statistic" style={{backgroundColor: '#865E5D'}}>
