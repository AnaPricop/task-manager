...
const Sidemenu = (project) => {
    ...
    const projectList =
        project.length === 0
            ...
            : project.projects.map((project, k) => <li project={project} key={k}>{project.title}</li>);
    return (
        <div className="d-flex flex-column flex-shrink-0 p-3 bg-light sidebar_dsh h-100  px-3 position-fixed" style={styles.sidebar_dsh}>
            ...
            <hr/>
                <ul className="nav nav-pills flex-column mb-auto">
                    ...
                    <li>
                        <a href="#" className={(active === 1 ? 'active ': 'null ') + "nav-link link-dark"}
                           onClick={() => setActive(1)}>
                            <svg className="bi me-2" width="16" height="16">
                    ...
                    <li>
                        <a href="#" className={(active === 2 ? 'active ': 'null ') + "nav-link link-dark"}
                           onClick={() => setActive(2)}>
                            <svg className="bi me-2" width="16" height="16">
                                {/*<use xlink:href="#table"/>*/}
                            </svg>
