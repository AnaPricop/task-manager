            ...
            <div className="col-4">
                <ul className="navbar-nav mr-auto">
                    <li className="nav-item active">
                        <a className="nav-link nav_link" style={styles.nav_link}>Home</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link nav_link" style={styles.nav_link}>Support</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link nav_link" style={styles.nav_link}>Contact Us</a>
                    </li>
                    <li className="nav-item">
                        <Link to="/login" className="textdecoration"  style={styles.textdecoration}>
                        <a className="nav-link nav_link" style={styles.nav_link}>Login</a>
                        </Link>
                    </li>
                    <li className="nav-item">
                        <Link to="/signup"  className="textdecoration"  style={styles.textdecoration}>
                            <a className="nav-link nav_link" style={styles.nav_link} href="#">Register</a>
                        </Link>
                    </li>
