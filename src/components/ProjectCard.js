...
const ProjectCard = ({project, projects, setProjects, setProjectsDel, info, setInfo, status}) => {
        ...
        axios
            ...
            .then((res) => {
                ...
                projects.map((datum, index) => {
                    console.log(datum)
                    if (datum._id === project._id)
                    {
                        index1 = index;
                    }
                })
                console.log(index1)
                let newArr = [...projects]; // copying the old datas array
                newArr[index1] = project;
                setProjects(newArr);
    ...
    return (
        <div className="card mx-5 my-4 col-lg-2 col-md-8 " key={project._id}>
            ...
            <div className="row" style={{paddingLeft: '15px'}}>
                <div className="col-8 " style={{paddingLeft: '30px'}} title="Change Image">
                    ...
                    <input className={focus ? "card-title-proj card-title1" : "card-title-proj"}
                ...
                <div className="col-3">
                    ...
                    <Dropdown onSelect={eventProject}>
                        <Dropdown.Toggle tag="text" id="dropdown-autoclose-true"
                                         className=' display-dots-proj settings-btn-proj'
                                         size="sm"
                        >
                        ...
                        <Dropdown.Menu className="dropdown-status">
                            <Dropdown.Item eventKey="0">View</Dropdown.Item>
            ...
            <div className="card-body " style={{marginLeft: '15px'}}>
                ...
                {/*    <div className="col col-lg-2" style={{textAlign: 'center', cursor: 'pointer'}} title="Open Project"*/}
                {/*         onClick={() => {*/}
                {/*             handleNext();*/}
                {/*         }}>*/}
                ...
                {/*        </svg>*/}
                {/*    </div>*/}
                {/*    <div className="col col-lg-2" style={{textAlign: 'center', cursor: 'pointer'}}*/}
